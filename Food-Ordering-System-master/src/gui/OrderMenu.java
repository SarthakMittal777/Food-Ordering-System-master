...
// 		// Load the image
ImageIcon imageIco = new ImageIcon(getClass().getResource("/qr.jpg"));
JLabel imageLabel = new JLabel(imageIco);
imageLabel.setBounds(150, 110, 100, 100); // Adjust position and size as needed
