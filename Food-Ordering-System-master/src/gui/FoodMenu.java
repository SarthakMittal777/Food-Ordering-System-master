...
public class FoodMenu {
	...
	void addIt(JTabbedPane tabbedPane, String text) throws IOException {
		...
		file[1] = new String("/buns.jpg");
		file[2] = new String("/dosaa.jpg");
		file[3] = new String("/patis.jpg");
		file[4] = new String("/RamenNoodles.png");
		file[5] = new String("/samosa.jpg");
		file[6] = new String("/vbun.jpg");
		file[7] = new String("/thaiFood.jpg");
		file[8] = new String("/momos.jpg");
		foodLabel[0] = new JLabel("Salad");
		foodLabel[1] = new JLabel("Japanese Bun");
		foodLabel[2] = new JLabel("Dosa");
		foodLabel[3] = new JLabel("Patis");
		foodLabel[4] = new JLabel("Noodles");
		foodLabel[5] = new JLabel("Samosa");
		foodLabel[6] = new JLabel("Veg Roll");
		foodLabel[7] = new JLabel("Thai Food");
		foodLabel[8] = new JLabel("Momos");
		price[0] = 60.0;
		price[1] = 40.0;
		price[2] = 80.0;
		price[3] = 20.0;
...
//			Image imageScaled = image.getScaledInstance(80, 95, Image.SCALE_SMOOTH);
	...
	void addIt1(JTabbedPane tabbedPane, String text) throws IOException {
		...
		priceDrinks[0] = 140.00;
		priceDrinks[1] = 90.00;
		priceDrinks[2] = 310.00;
		priceDrinks[3] = 590.00;
		priceDrinks[4] = 120.00;
		...
		// price[8] = 90.50;
			...
			for (int row = 0; row < rows; row++) {
				if (dtm.getValueAt(row, 3) == e.getSource()) {
					if (dtm.getValueAt(row, 0).equals("Salad")) {
					...
					} else if (dtm.getValueAt(row, 0).equals("Japanese Bun")) {
						...
						food3 = p3 * quantity;
					} else if (dtm.getValueAt(row, 0).equals("Patis")) {
						...
						food5 = p5 * quantity;
					} else if (dtm.getValueAt(row, 0).equals("Samosa")) {

						dtm.setValueAt(quantity, row, 1);
						dtm.setValueAt(p6 * quantity, row, 2);
						food6 = p6 * quantity;
					} else if (dtm.getValueAt(row, 0).equals("Veg Roll")) {
						...
						food8 = p8 * quantity;
					} else if (dtm.getValueAt(row, 0).equals("Momos")) {
